...
- [ ] Redaction precision and recall per entity type **on public corpora and the Canadian set**, with CIs. **Half done 2026-09-20 (0.6.0)**: `boundary redact eval` measures precision, recall, type accuracy, leak rate, over-redaction, round trip and latency per entity with Wilson intervals, on a corpus this repository generates, and the README carries the table. **The Canadian identifier set landed 2026-09-20 (0.6.1)**: 1,150 cases, every claimed shape in every written form at 100% found and masked except `file_number` at 50%, no recogniser firing on any of 700 near-misses, and business numbers, driver's licences and passports masked without being detected at all. What the line still wants is a **public corpus**, because a corpus this repository generates measures the engine against the shapes somebody here thought to generate
